...
helpers.registerCommand("remoteProjectsExporter", "project|*list", (exporter) => exporter.listProjects());
helpers.registerCommand("remoteProjectsExporter", "project|export", (exporter, args) => exporter.exportProject(args[0]));
