(function(){
    ...
    function HouseArrestClient() {

    }

    function getAfcClientCore(command, applicationIdentifier) {
        var plistService = new PlistService(mobileServices.HOUSE_ARREST);
    ...
    HouseArrestClient.prototype.GetAfcClientForAppDocuments = function(applicationIdentifier) {
        return getAfcClientCore("VendDocuments", applicationIdentifier);
    };

    HouseArrestClient.prototype.GetAfcClientForAppContainer = function(applicationIdentifier) {
        return getAfcClientCore("VendContainer", applicationIdentifier);
    };
