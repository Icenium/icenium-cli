...
import { PlatformServicesRunValidator } from "./platform-services-run-validator";

class WinSimulatorPlatformServices extends PlatformServicesRunValidator implements IExtensionPlatformServices {
...
class MacSimulatorPlatformServices extends PlatformServicesRunValidator implements IExtensionPlatformServices {
