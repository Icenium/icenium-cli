(function() {
	...
	var fs = require("fs"),
		...
		IOSDeploymentValidator = require("./validators/ios-deployment-validator"),
		querystring = require("querystring"),
		xopen = require("open"),
		async = require("async"),
		devicesService = require("./devices-service.js"),
		Q = require("q"),
		projectNameValidator = require("./validators/project-name-validator"),
		cachedProjectDir = "",
		projectData;
	...
	function setProjectProperty() {
		...
		updateProjectPropertyAndSave("set", args);
	}
