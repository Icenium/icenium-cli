(function() {
	...
	function createFromTemplate() {
		...
		var templateFileName = path.join(templatesDir, 'Telerik.Mobile.Cordova.' + template + '.zip');

		try {
			var templateFile = new AdmZip(templateFileName);
			templateFile.extractAllTo(projectDir, /*overwrite*/false);
		}
		catch(err) {
			console.log(err);
		}
