...
helpers.registerCommand("config", "dev-config-reset", (config, args) => config.reset(),  {disableAnalytics: true});
helpers.registerCommand("config", "dev-config-apply", (config, args) => config.apply(args[0]),  {disableAnalytics: true});
