(function() {
	...
	function fetchPlugin(pluginId) {
		if (!project.hasProject()) {
			log.error("You must specify the path to the project.");
			log.error("If not specified, the project is searched for in the current directory and all directories above it.");
		}
		else {
			configure()
			.then(function() {
