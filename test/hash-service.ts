...
describe("hash service", () => {
	describe("getFileHash", () => {
		...
		it("fails when input file encoding is not correct", async () => {
			failed = false;
		...
		it("fails when input hash algorithm is not correct", async () => {
			failed = false;
		...
		it("fails when hash encoding is not correct", async () => {
			failed = false;
		...
		it("does not fail when input parameters are correct", async () => {
			failed = false;
