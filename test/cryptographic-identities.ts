...
describe("IdentityManager unit tests", () => {
	let service: Server.IIdentityManager,
	...
	describe("autoselectProvision unit tests", () => {
		it("should throw if no provisions", () => {
			...
			assert.throws(async () => await  service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc']), 'No exception thrown when no provision found');
		});
		...
		it("should throw if no certificates", () => {
			...
			assert.throws(async () => await  service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc']), 'No exception thrown when no suitable certificate found');
		});
		...
		it("should throw if provision is expired", () => {
			...
			assert.throws(async () => await  service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc']), 'No exception thrown when provision expired');
		});
		...
		it("should throw if AdHoc provision does not contain given device identifier", () => {
			...
			assert.throws(async () => await  service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc'], 'device1'), "No exception thrown when given device identifier not present in mobile provision");
		});
	...
	describe("autoselectCertificate unit tests", () => {
		it("should throw if no valid certificates", () => {
			...
			assert.throws(async () => await  service.autoselectCertificate(provision), 'No exception thrown when no valid certificate found');
		});
