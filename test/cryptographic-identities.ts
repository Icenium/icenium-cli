...
describe("IdentityManager unit tests", () => {
	...
	describe("autoselectProvision unit tests", () => {
		it("should throw if no provisions", () => {
			...
			assert.isRejected(service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc']), 'No exception thrown when no provision found');
		});
		...
		it("should throw if no certificates", () => {
			...
			assert.isRejected(service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc']), 'No exception thrown when no suitable certificate found');
		});
		...
		it("should throw if provision is expired", () => {
			...
			assert.isRejected(service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc']), 'No exception thrown when provision expired');
		});
		...
		it("should throw if AdHoc provision does not contain given device identifier", () => {
			...
			assert.isRejected(service.autoselectProvision('com.telerik.WillSetLater', ['AdHoc'], 'device1'), "No exception thrown when given device identifier not present in mobile provision");
		});
	...
	describe("autoselectCertificate unit tests", () => {
		it("should throw if no valid certificates", () => {
			...
			assert.isRejected(service.autoselectCertificate(provision), 'No exception thrown when no valid certificate found');
		});
