...
Upload and publish your app | `$ appbuilder appmanager upload android [--certificate <Certificate ID>] [--download] --publish [--send-email] [--send-push] [--group <Group ID> [--group <Group ID>]*]`   
