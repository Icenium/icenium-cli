...
Configures anonymous error reporting for the AppBuilder CLI.
...
* `status` - Shows the current configuration for anonymous error reporting for the AppBuilder CLI.
