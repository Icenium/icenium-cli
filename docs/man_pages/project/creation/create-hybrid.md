...
* `<Template>` is the source template that you want to use. The default value is `KendoUI.Blank`. You can use the following templates: <%=#{cordovaProject.projectTemplatesString}%>.
