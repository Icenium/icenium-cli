...
Latest version: AppBuilder 3.6.3
<br/>Release date: December 20, 2016

> AppBuilder 3.6.3 is an update release. For a complete list of the improvements and updates available in this release, see <a href="http://docs.telerik.com/platform/appbuilder/release-notes/v3-6-3" target="_blank">AppBuilder 3.6.3 Release Notes</a>.<br/>For a complete list of the improvements and updates available in the earlier major release, see <a href="http://docs.telerik.com/platform/appbuilder/release-notes/v3-6" target="_blank">AppBuilder 3.6 Release Notes</a>.
