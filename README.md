...
Latest version: AppBuilder 3.6.1
<br/>Release date: December 7, 2016

> AppBuilder 3.6.1 is an update release. For a complete list of the improvements and updates available in this release, see <a href="http://docs.telerik.com/platform/appbuilder/release-notes/v3-6-1" target="_blank">AppBuilder 3.6.1 Release Notes</a>.<br/>For a complete list of the improvements and updates available in the earlier major release, see <a href="http://docs.telerik.com/platform/appbuilder/release-notes/v3-6" target="_blank">AppBuilder 3.6 Release Notes</a>.
